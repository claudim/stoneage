...
public class GreenBuildingSiteSquareSetupStrategy implements MISquareSetupStrategy {
    @Override
    public void setupSquare(MSquare square) {
        ...
        IPersistentGeneric dao = PersistenceServiceFactory.getInstance().getPersistenceClass(MHutToken.class.getSimpleName(), "verde");
